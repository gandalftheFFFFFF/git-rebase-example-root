...
#
# Example 2: Rebasing a feature branch on master to reduce conflicts on final
# merge
#

# Clean up

export example_name=example-2
...
# git merge origin/master  (to bring master changes into feature branch)
